...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="ethernet.php">网卡</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">网卡检测</h1>
          <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title" data-toggle="collapse" data-target="#demo"><strong>网卡状态变动</strong></h3>
              </div>
              <div class="panel-body" id="demo">
                <?php show_new_ethernet(); ?>
              </div>
        </div>

          <br><br><br>
          <button type="button" class="btn btn-info btn-lg" id="get_old_ethernet">查询旧的网卡列表</button>
        </div>
      </div>
    </div>
    ...
    $('#get_old_ethernet').click(function(){
    $.get("ajax.php?old_ethernet=1",function(data,status){
      $('#get_old_ethernet').after(content1 + data + content2);
    });
  });
    </script>
